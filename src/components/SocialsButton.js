  ...
  const SOCIALS = [
    {
      ...
      socialColor: '#1877F2',
      path: "http://facebook.com/adsplify" || 'adsplify',
    },
    {
      name: 'Instagram',
      icon: 'ant-design:instagram-filled',
      socialColor: '#E02D69',
      path: "http://instagram.com/adsplify" || 'adsplify',
    },
    {
      name: 'Linkedin',
      icon: 'eva:linkedin-fill',
      socialColor: '#007EBB',
      path:"http://linkedin.com/adsplify" || 'adsplify',
    },
    {
      name: 'Twitter',
      icon: 'eva:twitter-fill',
      socialColor: '#00AAEC',
      path: "http://twitter.com/adsplify" || 'adsplify',
    },
  ];
